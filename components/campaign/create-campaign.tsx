...
import { campaignFormSchema, type CampaignFormValues } from "@/lib/types/campaign"
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="HIGH_RISK">High Risk Customers</SelectItem>
                                            <SelectItem value="MEDIUM_RISK">Medium Risk Customers</SelectItem>
                                            <SelectItem value="LOW_RISK">Low Risk Customers</SelectItem>
                ...
                return (
                    <div className="space-y-6">
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <Card className="p-6">
                                <h3 className="text-lg font-semibold mb-4">Target & Schedule</h3>
                                <dl className="space-y-2">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <dd className="text-sm">{values.startDate ? format(values.startDate, "PPP") : 'Not set'}</dd>
                                    </div>
                                    <div>
                                        <dt className="text-sm font-medium text-muted-foreground">End Date</dt>
                                        <dd className="text-sm">{values.endDate ? format(values.endDate, "PPP") : 'Not set'}</dd>
                                    </div>
                                </dl>
                            </Card>
                        </div>
                        <Card className="p-6 bg-muted">
                            ...
                            <p className="text-sm">
                                This {values.riskLevel?.toLowerCase()} risk campaign named "{values.name}"
                                targets {values.targetAudience?.toLowerCase().replace('_', ' ')} customers.
                                It is scheduled to run from {values.startDate ? format(values.startDate, "MMMM d, yyyy") : 'TBD'}
                                to {values.endDate ? format(values.endDate, "MMMM d, yyyy") : 'TBD'}.
                            </p>
                        </Card>
                    </div>
                )
